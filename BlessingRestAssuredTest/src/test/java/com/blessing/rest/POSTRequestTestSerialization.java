...
// Creating object of POJO class and initialize values
...
// Create object of BookingDate class	
	...
	JsonPath js1= new JsonPath(PostResponse);
	String bookindId=js1.getString("bookingid");
	
	// DeSerialization  
	// GET Request
	System.out.println("------------GET Request after create Booking----------");
	GetPostResponsePojo Ppojo= given().
							   when().get("/booking/"+bookindId).as(GetPostResponsePojo.class);
